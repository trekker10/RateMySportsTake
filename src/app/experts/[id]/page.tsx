                ...
                <>
                  ...
                  {filteredFt.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {filteredFt.map((ft) => {
                        const v = fvTag(ft);
                        const filed = new Date(ft.date_made).toLocaleDateString("en-US", { month: "short", year: "2-digit" }).toUpperCase();
                        return (
                          <div key={ft.fantasy_take_id} className="bg-white border-2 border-gray-900 overflow-hidden">
                            {/* Header row — mirrors analyst TakeCard */}
                            ...
                            {/* Quote — beige background matching analyst */}
                            ...
                            {/* Footer — grader note + metadata */}
                            <div className="px-4 py-3 border-t border-gray-200 space-y-2">
                              {(ft as typeof ft & { grader_note?: string | null }).grader_note && (
